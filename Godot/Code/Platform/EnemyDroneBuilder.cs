    ...
    public class EnemyDroneBuilder
    {
        ...
        public static void BuildDrones(uint previousDay, uint currentDay)
        {
            if (GameCore.SingletonInstance.GameData.ActiveSaveFile.AtWar)
            {
                ...
                {
                    GameCore.SingletonInstance.GameData.ActiveSaveFile.EnemyBuildDay = currentDay + BuildFrequencies[BuildFrequencies.Length - 1 - GameCore.SingletonInstance.GameData.ActiveSaveFile.StarSystemsCaptured] / 100;
